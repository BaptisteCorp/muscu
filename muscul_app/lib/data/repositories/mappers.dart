...
Exercise exerciseFromRow(ExerciseEntity row) {
  ...
  return Exercise(
    ...
    progressionStrategy: enumByName(
      ProgressionStrategyKind.values,
      row.progressionStrategy,
      fallback: ProgressionStrategyKind.doubleProgression,
    ),
...
ExercisesCompanion exerciseToCompanion(Exercise e) {
  return ExercisesCompanion.insert(
    ...
    progressionStrategy: drift.Value(e.progressionStrategy.name),
...
WorkoutSessionsCompanion sessionToCompanion(WorkoutSession s) =>
    WorkoutSessionsCompanion.insert(
      ...
      plannedFor: drift.Value(s.plannedFor),
